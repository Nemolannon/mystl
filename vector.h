...
#define MY_VECTOR_MAX_SIZE 4294967296 // Найди свой предел: определи максимальную высоту дома перед #include
#endif

namespase my{   // Очевидно, что такие опасные эксперименты лучше проводить на закрытой территории
...
class vector    // Фабрика клонов... Вот оно, вместилище боли и ужаса..
{
    ...
    const std::size_t MAX_SIZE; // Когда-нибудь это закончится
    ...
    std::size_t nCounter;  // Количество занятых квартир/этажей
